...
resource "aws_cloudwatch_log_group" "cloudtrail" {
  ...
  tags = {
    LogType   = "cloudtrail"
    Purpose   = "S3 Data Events for debugging Bronze bucket notifications"
    Temporary = "true"
  }
}
...
# ============================================================================
# CloudTrail for S3 Data Events Debugging
# ============================================================================
...
resource "aws_s3_bucket" "cloudtrail" {
  ...
  tags = {
    ...
    Purpose   = "CloudTrail logs for debugging S3 Data Events"
    Temporary = "true"
  }
}
...
# CloudTrail trail for Bronze bucket S3 Data Events
resource "aws_cloudtrail" "bronze_s3_events" {
  name                          = "${var.project_name}-bronze-s3-events"
  ...
  tags = {
    Name      = "${var.project_name}-bronze-s3-events-trail"
    Purpose   = "Debug S3 Data Events for Bronze bucket Lambda triggers"
    Temporary = "true"
  }
