...
class S3DataHandler:
    ...
    def read_silver_layer_data(self, s3_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            raise Exception(f"Failed to read Silver layer data from {s3_path}: {str(e)}")
    ...
    def write_gold_layer_data(
        ...
        try:
            ...
            raise Exception(f"Failed to write Gold layer data to {base_s3_path}: {str(e)}")
    
    def read_existing_season_data(self, player_id: str, season: str, base_s3_path: str) -> pd.DataFrame:
        """
