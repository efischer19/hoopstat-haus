...
class TestLambdaHandler:
    ...
    def test_successful_processing(self, mock_extract_s3, mock_s3_handler_class):
        ...
        mock_s3_handler.write_gold_layer_data.return_value = [
            "s3://path1",
            "s3://path2",
        ]
        ...
        assert (
            mock_s3_handler.write_gold_layer_data.call_count == 2
        )  # Daily + season stats
    ...
    def test_empty_silver_data_handling(self, mock_extract_s3, mock_s3_handler_class):
        ...
        mock_s3_handler = Mock()
        mock_s3_handler_class.return_value = mock_s3_handler
        mock_s3_handler.read_silver_layer_data.return_value = (
            pd.DataFrame()
        )  # Empty data
...
class TestCreateResponse:
    ...
    def test_success_response(self):
        ...
        response = create_response(
            "success", "Processing completed", "test-correlation-id", 100, 45.67
        )
    ...
    def test_error_response(self):
        ...
        response = create_response(
            "error", "Processing failed", "test-correlation-id", 50, 23.45
        )
...
class TestLoggingFunctions:
    ...
    def test_log_info_with_extra(self, mock_print):
        ...
        extra_data = {"records_processed": 100, "duration_in_seconds": 45.67}
