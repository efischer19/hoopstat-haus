...
def correlation_context(correlation_id: Optional[str] = None) -> Generator[str, None, None]:
    ...
    try:
        ...
        logger.info("Started operation with correlation tracking", 
        ...
        logger.debug("Correlation context restored", 
...
def with_correlation(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if correlation_id:
            logger.debug("Function called with correlation tracking",
