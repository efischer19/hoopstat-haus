...
class TestBackfillRunnerIntegration:
    ...
    def test_resume_from_checkpoint(self, mock_s3_class, mock_nba_class):
        ...
        mock_nba.get_box_score_traditional.return_value = {"resultSets": [{"headers": [], "rowSet": []}]}
        mock_nba.get_box_score_advanced.return_value = {"resultSets": [{"headers": [], "rowSet": []}]}
        mock_nba.get_play_by_play.return_value = {"resultSets": [{"headers": [], "rowSet": []}]}
        mock_nba.get_session_stats.return_value = {"total_requests": 3, "successful_requests": 3, "failed_requests": 0, "rate_limit_hits": 0}
        mock_nba_class.return_value = mock_nba
